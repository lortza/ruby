...
def introduce_card(card_id)
  "I've drawn the #{@picks[card_id][:name]} card. The #{@picks[card_id][:name]} card stands for #{@picks[card_id][:meaning].downcase}."
end #introduce_card(card_id)
